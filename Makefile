.PHONY: test smoke docs-python-exit docs-python-exit-test stage1-test stage1-conformance stage1-smoke stage1-bench-gate stage1-crap-thresholds stage1-crap-thresholds-test stage1-run
