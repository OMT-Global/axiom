...
| --- | --- | --- | --- |
| Direct native parity matrix | Every supported stage1 surface has a direct-native status row and linked blocker when incomplete. | Implemented as the checked runtime ABI matrix; remaining incomplete value-feature rows block through #1124. | [#927](https://github.com/OMT-Global/axiomlang/issues/927) |
