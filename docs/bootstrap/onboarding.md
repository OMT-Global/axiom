    ...
    - Confirm branch protection points at the expected required status checks: `CI Gate`, `test (python 3.11 hosted)`, `test (python 3.12 self-hosted)`, `test (python 3.13 hosted)`.
