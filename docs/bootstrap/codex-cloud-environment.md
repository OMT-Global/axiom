...
- This repo uses required PR checks `CI Gate`, `test (python 3.11 hosted)`, `test (python 3.12 self-hosted)`, `test (python 3.13 hosted)`, so cloud review tasks should preserve that contract.
