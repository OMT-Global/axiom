...
- Today only the `generated-rust` backend is implemented; the backend seam is preparatory groundwork for later native-backend expansion, not completion of #105 (part of #105).
