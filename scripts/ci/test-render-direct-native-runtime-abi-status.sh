...
grep -Fq '| `numeric.scalars` | `partial` | #1001 | evidence:1, runtime:1 |' "$temp_dir/status.md"
grep -Fq '| `io.logging_stdio` | `partial` | #1001 | evidence:1, runtime:2 |' "$temp_dir/status.md"
