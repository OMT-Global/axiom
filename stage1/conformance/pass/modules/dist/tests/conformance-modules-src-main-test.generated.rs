...
const AXIOM_PACKAGE_ROOT: &str = "/Users/johnteneyckjr./src/axiom/stage1/conformance/pass/modules";
const AXIOM_FS_ROOT: &str = "/Users/johnteneyckjr./src/axiom/stage1/conformance/pass/modules";
...
fn conformance_modules_format_banner(name: String) -> String {
    return format!("{}{}", conformance_modules_format_prefix(), name);
}

#[allow(non_snake_case)]
fn conformance_modules_format_prefix() -> String {
    return String::from("module ");
}

#[allow(non_snake_case)]
fn conformance_modules_math_lucky(base: i64) -> i64 {
    return base + 2;
}
...
fn main() -> std::process::ExitCode {
    ...
    let result = panic::catch_unwind(|| {
        println!("{}", conformance_modules_math_lucky(40));
        println!("{}", conformance_modules_format_banner(String::from("import")));
    });
    match result {
