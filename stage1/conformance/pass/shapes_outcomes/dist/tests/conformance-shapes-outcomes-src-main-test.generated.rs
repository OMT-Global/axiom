...
const AXIOM_PACKAGE_ROOT: &str = "/Users/johnteneyckjr./src/axiom/stage1/conformance/pass/shapes_outcomes";
const AXIOM_FS_ROOT: &str = "/Users/johnteneyckjr./src/axiom/stage1/conformance/pass/shapes_outcomes";
...
#[allow(dead_code)]
#[derive(Debug, PartialEq)]
enum conformance_shapes_outcomes_main_test_Status {
    Queued(conformance_shapes_outcomes_main_test_Pipeline),
    Done {
        id: i64,
        label: String,
    },
...
#[allow(dead_code)]
#[derive(Debug, PartialEq)]
struct conformance_shapes_outcomes_main_test_Pipeline {
    name: String,
    steps: i64,
    ready: bool,
}
...
fn conformance_shapes_outcomes_main_test_maybe_pipeline(ready: bool) -> Option<conformance_shapes_outcomes_main_test_Pipeline> {
    if ready {
        return Option::Some(conformance_shapes_outcomes_main_test_Pipeline { name: String::from("deploy"), steps: 3, ready: true });
    }
    return Option::None;
}

#[allow(non_snake_case)]
fn conformance_shapes_outcomes_main_test_load_status(ready: bool) -> Result<conformance_shapes_outcomes_main_test_Status, String> {
    if ready {
        return Result::Ok(conformance_shapes_outcomes_main_test_Status::Done { id: 42, label: String::from("built") });
    }
    return Result::Err(String::from("blocked"));
}

#[allow(non_snake_case)]
fn conformance_shapes_outcomes_main_test_describe_status(status: conformance_shapes_outcomes_main_test_Status) -> String {
    match status {
        conformance_shapes_outcomes_main_test_Status::Queued(pipeline) => {
            println!("{}", (pipeline).steps);
            return (pipeline).name;
        },
        conformance_shapes_outcomes_main_test_Status::Done { id, label } => {
            println!("{}", id);
            return label;
        },
        conformance_shapes_outcomes_main_test_Status::Failed(message) => {
            return message;
        },
    }
}
...
#[allow(non_snake_case)]
fn conformance_shapes_outcomes_main_test_describe_option(value: Option<conformance_shapes_outcomes_main_test_Pipeline>) -> String {
    match value {
...
#[allow(non_snake_case)]
fn conformance_shapes_outcomes_main_test_describe_result(value: Result<conformance_shapes_outcomes_main_test_Status, String>) -> String {
    match value {
        Result::Ok(status) => {
            return conformance_shapes_outcomes_main_test_describe_status(status);
        },
        Result::Err(message) => {
            return message;
        },
...
fn main() -> std::process::ExitCode {
    ...
    let result = panic::catch_unwind(|| {
        let queued: conformance_shapes_outcomes_main_test_Status = conformance_shapes_outcomes_main_test_Status::Queued(conformance_shapes_outcomes_main_test_Pipeline { name: String::from("queued"), steps: 2, ready: true });
        println!("{}", conformance_shapes_outcomes_main_test_describe_status(queued));
        println!("{}", conformance_shapes_outcomes_main_test_describe_option(conformance_shapes_outcomes_main_test_maybe_pipeline(true)));
        println!("{}", conformance_shapes_outcomes_main_test_describe_option(conformance_shapes_outcomes_main_test_maybe_pipeline(false)));
        println!("{}", conformance_shapes_outcomes_main_test_describe_result(conformance_shapes_outcomes_main_test_load_status(true)));
        println!("{}", conformance_shapes_outcomes_main_test_describe_result(conformance_shapes_outcomes_main_test_load_status(false)));
    });
    match result {
